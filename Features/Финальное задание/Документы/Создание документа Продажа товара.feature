...
Сценарий: _3.0301 Подготовительный сценарий
...
Сценарий: _3.0302 Создание документа Продажа товара (организация без валютного учета)
...
Сценарий: _3.0303 Создание документа Продажа товара (организация с валютным учетом)
	// Сценарий выполняем под менеджером по продажам
	И я подключаю TestClient "Менеджер по продажам" логин "Менеджер по продажам" пароль ""
* Открытие формы создания документа
	И я закрываю все окна клиентского приложения
...
Сценарий: _3.0304 Видимость валюты взаиморасчетов
* Открытие формы создания документа
	И я закрываю все окна клиентского приложения
	И Открытие формы создания документа Продажа товара
...
Сценарий: _3.0305 Доступность склада при учете по складам
...
Сценарий: _3.0306 Заполнение вида цены покупателя
* Открытие формы создания документа
	И я закрываю все окна клиентского приложения
	И Открытие формы создания документа Продажа товара
...
Сценарий: _3.0307 Проверка указания количества для услуг
* Открытие формы создания документа
	И я закрываю все окна клиентского приложения
	И Открытие формы создания документа Продажа товара	
* Добавление услуги
...
Сценарий: _3.0308 Автоматическая подстановка цен товаров
