...
Функционал: загрузка констант и организаций

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

@ТипШага: Загрузка данных
@Описание: Экспортный сценарий заполнения констант в демобазе
@ПримерИспользования: И заполняю константы
Сценарий: Заполняю константы
